...
public class Tr0 {
    ...
    // 历史交易回测交易
    private final List<Td0> endGame = new ArrayList<>(), backTrade = new ArrayList<>();

    public Tr0(LocalDate startDate, LocalDate middleDate, LocalDate endDate) {
        this.startDate = startDate;
        this.endDate = endDate;
        this.middleDate = middleDate;
    }

    public void add(Td0 record) {
